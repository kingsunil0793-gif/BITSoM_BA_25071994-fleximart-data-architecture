...
-- Only include categories that have generated
-- more than ₹10,000 in revenue.
...
-- of orders, total revenue, and the running total
-- of revenue from January onwards.
-- -----------------------------------------------------
...
SELECT
    ...
    SUM(SUM(oi.subtotal)) OVER (
        ...
        ROWS BETWEEN UNBOUNDED PRECEDING A